...
class m220714_095642_create_table_view_expiry_project_province extends Migration
{
    ...
    {
        $this->dropTable('{{%view_expiry_project_province}}');
    }
}
